  ...
  const initializeSession = async () => {
    ...
    try {
      ...
      try {
        ...
        await LearningProgressClient.saveLearningProgress(initialProgressData);
        console.log('初始学习会话已保存到数据库');
      } catch (saveError) {
        console.error('保存初始学习会话失败:', saveError);
      }
